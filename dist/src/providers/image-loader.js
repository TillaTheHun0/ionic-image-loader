...
var ImageLoader = (function () {
    ...
    function () {
        ...
        var clear = function () {
            ...
            _this.isInit = false;
            _this.file
                .removeRecursively(_this.file.cacheDirectory, _this.config.cacheDirectoryName)
                .then(function () {
    ...
    function (replace) {
        ...
        if (replace) {
            ...
            cacheDirectoryPromise = this.cacheDirectoryExists(this.file.cacheDirectory).catch(function () {
                return _this.file.createDir(_this.file.cacheDirectory, _this.config.cacheDirectoryName, false);
            });
        }
